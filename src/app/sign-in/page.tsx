...
// useSearchParams() requires a Suspense boundary in Next.js 14 during static generation
const SignInForm = () => {
  ...
  return (
    <div className="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full">
      ...
      <div className="mt-8 text-center text-sm text-gray-500">
        ...
        <Link href="/sign-up" className="text-lamaSky font-semibold hover:underline">
          Request Access
        </Link>
      </div>
    </div>
...
const SignInPage = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F7F8FA] p-4">
      <Suspense fallback={
        <div className="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full flex items-center justify-center h-64">
